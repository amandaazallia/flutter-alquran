package com.amanda.alquran_app.adapter;
...
public class SurahAdapter extends RecyclerView.Adapter<SurahAdapter.ViewHolder> {
    ...
    private List<Surah> items;
    private SurahAdapter.onSelectData onSelectData;
    private Context mContext;

    public interface onSelectData {
        void onSelected(Surah modelSurah);
    }

    public SurahAdapter(Context context, List<Surah> items, SurahAdapter.onSelectData xSelectData) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final Surah data = items.get(position);
